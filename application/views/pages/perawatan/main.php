            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="<?= base_url() ?>t_perawatan/form_perawatan/<?= $this->uri->segment(3) ?>/?x=<?= $x ?>" id="add-new" class="btn default yellow-stripe btn-circle">
    ...
    $('#datatable tbody').on('click', '.delete', function (e) {
        ...
        if (confirm('Anda yakin menghapus data ini ?')) {
            $.ajax({
                cache: false,
                type: "get",
                url: "<?= base_url() ?>T_perawatan/hapus_json",
                data: "id=" + id,
