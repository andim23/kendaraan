...
<table class="table table-striped table-bordered table-hover" id="datatable">
    <thead>
        ...
        <tr role="row" class="filter">
            <td>&nbsp;</td>
            <td><input type="text" class="form-control form-filter input-sm input-circle" name="perawatan"></td>
            <td><input type="text" class="form-control form-filter input-sm input-circle" name="group"></td>
            <td align="center">&nbsp;</td>
        </tr>
    </thead>
    <tbody>
