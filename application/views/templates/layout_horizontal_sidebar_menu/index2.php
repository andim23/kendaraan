...
<!-- BEGIN THEME STYLES -->
<link href="<?= base_url() ?>theme/assets/global/css/components.css" rel="stylesheet" type="text/css"/>
...
<link id="style_color" href="<?= base_url() ?>theme/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css"/>
		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 250px;">
								<li>
									...
									<span class="photo">
									<img src="<?= base_url() ?>theme/assets/admin/layout/img/avatar2.jpg" alt=""/>
									</span>
									<span class="subject">
									<span class="from">
									Lisa Wong </span>
								...
								<li>
									<a href="inbox.html?a=view">
									<span class="photo">
									<img src="<?= base_url() ?>theme/assets/admin/layout/img/avatar3.jpg" alt=""/>
									</span>
									<span class="subject">
									<span class="from">
									Richard Doe </span>
								...
								<li>
									<a href="inbox.html?a=view">
									<span class="photo">
									<img src="<?= base_url() ?>theme/assets/admin/layout/img/avatar1.jpg" alt=""/>
									</span>
									<span class="subject">
									<span class="from">
									Bob Nilson </span>
				...
				<li class="dropdown dropdown-user">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
					<img alt="" class="img-circle hide1" src="<?= base_url() ?>theme/assets/admin/layout/img/avatar3_small.jpg"/>
				...
				<li>
					...
					<ul class="sub-menu">
						<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="Complete eCommerce Frontend Theme For Metronic Admin">
							<a href="http://keenthemes.com/preview/metronic/theme/templates/frontend/shop-<?= base_url() ?>page" target="_blank">
							<span class="title">
						...
						<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="Complete One Page Parallax Frontend Theme For Metronic Admin">
							<a href="http://keenthemes.com/preview/metronic/theme/templates/frontend/onepage-<?= base_url() ?>page" target="_blank">
							<span class="title">
						...
						<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="<?= base_url() ?>theme/assets/admin/layout/img/avatar3.jpg" alt="...">
								...
								<li class="media">
									<img class="media-object" src="<?= base_url() ?>theme/assets/admin/layout/img/avatar1.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?= base_url() ?>theme/assets/admin/layout/img/avatar4.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="<?= base_url() ?>theme/assets/admin/layout/img/avatar2.jpg" alt="...">
									<div class="media-body">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="<?= base_url() ?>theme/assets/admin/layout/img/avatar6.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?= base_url() ?>theme/assets/admin/layout/img/avatar7.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="<?= base_url() ?>theme/assets/admin/layout/img/avatar8.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?= base_url() ?>theme/assets/admin/layout/img/avatar9.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="<?= base_url() ?>theme/assets/admin/layout/img/avatar10.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?= base_url() ?>theme/assets/admin/layout/img/avatar11.jpg" alt="...">
									<div class="media-body">
						...
						<div class="page-quick-sidebar-item">
							<div class="page-quick-sidebar-chat-user">
								...
								<div class="page-quick-sidebar-chat-user-messages">
									<div class="post out">
										<img class="avatar" alt="" src="<?= base_url() ?>theme/assets/admin/layout/img/avatar3.jpg"/>
										<div class="message">
									...
									<div class="post in">
										<img class="avatar" alt="" src="<?= base_url() ?>theme/assets/admin/layout/img/avatar2.jpg"/>
										<div class="message">
											<span class="arrow"></span>
