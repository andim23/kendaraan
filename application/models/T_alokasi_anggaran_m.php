...
/**
 * Description of T_alokasi_anggaran_m
 *
 * @author Selamet Subu - Dell 5459
 */
class T_alokasi_anggaran_m extends My_model {

    //put your code here
    var $table = "t_alokasi_anggaran";
    var $view = "t_alokasi_anggaran_view";
    var $primary_key = "id_alokasi";
    ...
    public function get_alokasi_by_id_and_tahun($id_kendaraan = null, $tahun=null){
        $this->db->where(array('id_kendaraan' => $id_kendaraan, 'tahun_anggaran' => $tahun));
        $query = $this->db->get('t_alokasi_anggaran_sum_view');
        $result = $query->result();
        return $result;
    }
    ...
    public function get_tahun_anggaran(){
        $sql = "select DISTINCT x.tahun_anggaran from t_alokasi_anggaran x order by x.tahun_anggaran desc";
